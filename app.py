...
def generate_report():
    ...
    try:
        with connect_db() as conn:
            ...
            cur.execute('''SELECT month, year, income, Vacation, daily_transportation, utilities, savings,
            ...
            ep=[]
            for cat in expense_data:
                if(cat[0] !=month and cat[1]!=year):
                    ep.append(cat)
                else:
                    ep.append(cat)
                    break
            cur.execute('''SELECT Vacation, daily_transportation, utilities, savings,
                        housing, debt_payments, healthcare, personal_care, food, insurance, 
                        education, entertainment, charity, taxes, miscellaneous 
            ...
            if sum(personal_data) > personal_limit:
                ...
                personal_attributes = ['entertainment', 'personal_care', 'vacation']
                ...
                essential_attributes= ['housing', 'utilities', 'daily_transportation', 'food', 'debt_payments', 'healthcare', 'insurance', 'taxes']                    
                max_category = essential_attributes[max_index]
                ...
                savings_attributes = ['education', 'charity','miscellaneous']
